...
https://github.com/XeldarAlz/FFXIV-AutoTripleTriadGrind/security/advisories/new
...
- The plugin teleporting, talking to NPCs, or persisting something it shouldn't (beyond the documented Triple Triad automation, which is the feature).
- Data exfiltration: this plugin makes no network calls by design; any network traffic would be a bug.

What doesn't:

- The fact that Auto Triple Triad Grind plays Triple Triad for you. That's against Square Enix's Terms of Service and is the whole feature; turning it on is the user's choice.
